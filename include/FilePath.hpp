...
/// 生成式人工智慧導論製作的手寫字型
/// </summary>
constexpr auto MyFontPath = MY_RESOURCE_DIR "/Font/t112590005noto.ttf";
...
/// 1-2水管地圖圖片路徑
/// </summary>
constexpr auto Background_1_2_Pipe_ImagePath = "imgs/super mario/Maps/SuperMarioBrosMap1-2BG in pipe.png";
...
/// 階梯圖片路徑(深色)
/// </summary>
constexpr auto StairsBrickDarkImagePath = "imgs/super mario/StairsBrickDark.png";
