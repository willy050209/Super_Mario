...
namespace MyAPP {
	...
	namespace Form {
		...
		struct FormAndObject {
			...
			/// 文字方塊
			/// </summary>
			std::vector<std::shared_ptr<Object::TextObject>> m_Texts;
			/// <summary>
			/// 圖片方塊
			/// </summary>std::string
			std::vector<std::shared_ptr<Object::ImageObject>> m_Images;
			/// <summary>
			/// 按鈕
			/// </summary>
			std::vector<std::shared_ptr<Object::Button>> m_Buttons;
			/// <summary>
			/// 角色
			/// </summary>
			std::vector<std::shared_ptr<Object::Character>> m_Characters;
			/// <summary>
			/// 事件
			/// </summary>
			std::vector<std::shared_ptr<Object::EventObject>> m_Events;
		};
		...
		public:
			...
			inline void addObject(const std::string& formName, std::shared_ptr<Object::EventObject>& event) noexcept {
			...
			inline void addObject(const std::string& formName, std::shared_ptr<Object::Button>& button) noexcept {
			...
			inline void addObject(const std::string& formName, std::shared_ptr<Object::Character>& character) noexcept {
			...
			inline void addObject(const std::string& formName, std::shared_ptr<Object::TextObject>& text) noexcept {
		...
		private:
			...
			inline void addForm(const std::string& formName, std::shared_ptr<MyAPP::Form::Object::Object> obj) noexcept {
